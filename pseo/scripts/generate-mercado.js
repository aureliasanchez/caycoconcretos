...
<head>
    ...
    <style>
      ...
      /* Teseo Intelligence Banner */
      .teseo-intel { display:flex; align-items:center; gap:24px; background:linear-gradient(95deg,#1f282d 0%, #2a353c 100%); border-left:4px solid var(--accent); padding:28px 32px; margin:40px 0 0; box-shadow:0 6px 28px rgba(0,0,0,.08); position:relative; overflow:hidden; }
      .teseo-intel::after { content:''; position:absolute; right:-40px; top:50%; transform:translateY(-50%); width:200px; height:200px; background:radial-gradient(circle, rgba(211,47,47,.22) 0%, transparent 70%); pointer-events:none; }
      .teseo-intel-icon { width:64px; height:64px; flex-shrink:0; display:flex; align-items:center; justify-content:center; background:rgba(211,47,47,.22); border-radius:50%; position:relative; z-index:2; }
      .teseo-intel-icon i { color:var(--accent); font-size:24px; }
      .teseo-intel-body { flex:1; position:relative; z-index:2; }
      .teseo-intel-tag { font-size:11px; text-transform:uppercase; letter-spacing:2.5px; color:var(--accent); font-weight:800; display:block; margin-bottom:8px; }
      .teseo-intel-text { color:rgba(255,255,255,.88); font-size:14px; line-height:175%; margin:0 0 12px; font-family:'Raleway',sans-serif; }
      .teseo-intel-text strong { color:#fff; font-weight:700; }
      .teseo-intel-link { font-size:12px; text-transform:uppercase; letter-spacing:1.5px; color:var(--accent); font-weight:800; text-decoration:none; display:inline-flex; align-items:center; gap:8px; transition:.25s; padding:8px 18px; border:1px solid var(--accent); border-radius:4px; }
      .teseo-intel-link:hover { color:#fff; background:var(--accent); }
      ...
      @media(max-width:768px) {
        .teseo-intel { flex-direction:column; text-align:center; padding:26px 22px; gap:16px; }
        .teseo-intel-link { justify-content:center; }
      }
    ...
    <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"Dataset","name":"Mercado de Concreto Premezclado — CAYCO 2026","description":"Conjunto de datos de demanda (m³), valor de mercado, proyectos verificados, zonificación y especificaciones técnicas del mercado de concreto premezclado en Querétaro, Hidalgo, Puebla y Estado de México.","url":"https://cayco.mx/mercado-concreto/","keywords":["concreto premezclado","mercado de concreto","demanda de concreto","Querétaro","Hidalgo","Puebla"],"spatialCoverage":["Querétaro","Hidalgo","Puebla","Estado de México"],"temporalCoverage":"2026","creator":{"@type":"Organization","name":"Teseo Data Lab — Unidad de Inteligencia de Mercado","url":"https://teseodata.com","description":"Inteligencia de datos, modelado econométrico y desarrollo tecnológico para la industria del concreto y la construcción en México.","sameAs":["https://www.linkedin.com/company/teseo-data-center/","https://www.instagram.com/teseo_data_lab/","https://www.facebook.com/teseodatalab"]},"publisher":{"@type":"Organization","name":"CAYCO Concreto Premezclado","url":"https://cayco.mx"},"provider":{"@type":"Organization","name":"Teseo Data Lab","url":"https://teseodata.com"},"license":"https://teseodata.com"}
    </script>
    <script type="application/ld+json">
...
<body>
    ...
    <div class="container">
        ...
        <!-- ═══ TESEO MARKET INTELLIGENCE ATTRIBUTION ═══ -->
        <aside class="teseo-intel" aria-label="Fuente de los datos de mercado">
            <div class="teseo-intel-icon"><i class="fas fa-chart-line"></i></div>
            <div class="teseo-intel-body">
                <span class="teseo-intel-tag">Inteligencia de Mercado · Data Driven</span>
                <p class="teseo-intel-text">Los datos de demanda (m³), valor de mercado, proyectos verificados y zonificación presentados en esta página son producidos y mantenidos por la <strong>Unidad de Inteligencia de Mercado de Teseo Data Lab</strong> — partner tecnológico de CAYCO en análisis sectorial, modelado econométrico y monitoreo de obra pública y privada en México.</p>
                <a href="https://teseodata.com" target="_blank" rel="noopener" title="Teseo Data Lab — Inteligencia de datos para la industria del concreto" class="teseo-intel-link">
                    Conoce a Teseo Data Lab <i class="fas fa-arrow-right"></i>
                </a>
            </div>
        </aside>
    </div>
