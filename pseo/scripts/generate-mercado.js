...
<head>
    ...
    <style>
      ...
      /* CTA */
      .mkt-cta { background:linear-gradient(135deg, var(--accent), #b71c1c); padding:60px; text-align:center; }
      ...
      .mkt-cta-btns a { padding:14px 30px; font-size:14px; font-weight:700; text-decoration:none; text-transform:uppercase; letter-spacing:.5px; transition:.2s; }
      ...
      .mkt-cta-btns .btn-form { background:transparent; color:#fff; border:2px solid rgba(255,255,255,.5); }
      .mkt-cta-btns .btn-form:hover { background:#fff; color:var(--accent); border-color:#fff; }
...
${topProjects.map((p, i) => `                    <div class="mkt-project">
                ...
                <div class="col-lg-4">
                    <div style="background:#0a0a0a;padding:30px;height:100%">
        ...
        <div class="container mil-p-0-120">
            <div class="mkt-cta">
                ...
                <div class="mkt-cta-btns">
                    ...
                    <a href="tel:+524424397563" class="btn-tel"><i class="fas fa-phone-alt"></i>&nbsp; (442) 439 7563</a>
